...
namespace BilQalaam.Application.DTOs.Students
{
    public class CreateStudentDto
    {
        ...
        [StringLength(100, MinimumLength = 3, ErrorMessage = "ÇÓã ÇáØÇáÈ íÌÈ Ãä íßæä Èíä 3 æ 100 ÍÑİ")]
        ...
        // ?? ÇáÚÇÆáÉ ÇáãæßáÉ ááØÇáÈ (ID ãä ÌÏæá Families)
